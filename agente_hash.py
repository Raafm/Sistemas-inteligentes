...
def arrow(screen, start, end, lcolor = Flame, tricolor = Dark_red,  trirad= 2, thickness=3):
...
class Agent:
    ...
    def __init__(self, pos0 , screen, color_tail = Cyan, color_head = royal_blue, step = 5):
        self.pos = pos0
    ...
    def move(self,food_pos,show = False,time_wait = 0):
        pos_antiga = self.pos
        ...
        arrow(self.screen, pos_antiga, self.pos,self.color_tail,self.color_head,thickness = 4,trirad = 5)
